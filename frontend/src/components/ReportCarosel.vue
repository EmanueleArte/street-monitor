...
<template>
    <section
        v-if="currentReport"
        class="z-10 absolute bottom-2 left-0 flex w-full md:w-1/3 items-end content-center justify-center overflow-x-hidden md:w-lg md:gap-1 md:rounded-none md:border-0 md:left-1/4">
