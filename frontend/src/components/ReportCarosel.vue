...
<template>
    <section
        v-if="currentReport"
        class="pt-10 z-10 absolute h-1/4 bottom-3 md:left-1/4 flex w-full md:w-3/4 content-center justify-center md:justify-start overflow-x-hidden md:w-lg md:gap-1 md:rounded-none md:border-0 md:px-3">
