...
<template>
    <section class="p-4 mt-10 pt-7 md:m-0 md:pt-0 h-full">
        <h1 v-if="notifications?.length > 0" class="text-2xl md:hidden">Notifications</h1>


        <div v-else class="mt-40 md:m-0 flex flex-col flex-wrap p-10 justify-center h-full text-center text-black/50">
