    ...
    >
        ...
        <section class="w-full px-3 py-2 text-sm shadow-md shadow-black/40">
            ...
            <div class="grid grid-cols-3 grid-rows-3">
                <!-- coords -->
                <div class="w-full text-slate-600 col-span-2 row-span-2 flex gap-2 lowercase">
                ...
                <button :class="props.report.close_datetime ? 'row-span-2' : 'row-span-3'" class="my-auto w-full cursor-pointer rounded bg-primary-600 py-2 font-medium text-light capitalize">button</button>
                <!-- dates -->
