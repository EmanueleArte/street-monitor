        ...
        <div class="flex flex-col">
          <div class="grid grid-cols-3 grid-rows-3 text-xs">
            ...
            >
              ...
              <p @click="moveToReport"
                 class="w-3/4 cursor-pointer text-primary-600 my-auto hover:text-primary-700 duration-300"
              >
            ...
            <!-- dates -->
            <div class="flex gap-x-3 flex-wrap text-slate-600"
                 :class="props.report.close_datetime ? 'col-span-3 mt-0.5' : 'col-span-2'"
            >
              <!-- open -->
